package me.ianmcgregor.species.contexts {
	 ...
	 * @author McFamily
	 */
	public class GameOverContext implements IContext {
		/**
		 * _container 
		 */
		 ...
		 * @return 
		 */
		public function GameOverContext(container : GameContainer, main : Species) {
			super();
		...
		public function init() : void {
			...
			_menu.addChild(_title = new QuickText(100, 10, "GAME OVER"));
