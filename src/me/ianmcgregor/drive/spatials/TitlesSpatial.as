package me.ianmcgregor.drive.spatials {
	...
	import me.ianmcgregor.drive.spatials.gfx.TitlesGfx;
	...
	public final class TitlesSpatial extends Spatial {
		...
		override public function initalize(g : GameContainer) : void {
			 ...
			 * _gfx
			 */
//			if(!_gfx)_gfx = new TitlesGfx(g.assets.getTexture("title"));
			if(!_gfx)_gfx = new TitlesGfx(g.getWidth(), g.getHeight(), g.assets.getTextureAtlas(Constants.SPRITES));
			g.addChild(_gfx);
