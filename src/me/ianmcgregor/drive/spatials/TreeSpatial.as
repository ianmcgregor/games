package me.ianmcgregor.drive.spatials {
	 ...
	 * @author ianmcgregor
	 */
	public final class TreeSpatial extends Spatial {
		/**
		 * _gfx 
		 */
		 ...
		 * @return 
		 */
		public function TreeSpatial(world : World, owner : Entity) {
			super(world, owner);
		}
		...
		override public function initalize(g : GameContainer) : void {
			 ...
			 * gfx
			 */
			g.addChild(_gfx = new ImageGfx(g.assets.getTexture(Constants.TREE)));
