...
//			addChild(gfx);
			 ...
			 */
			var title : TextField;
			addChild(title = new TextField(600, 100, Constants.TITLE_TEXT, Constants.FONT, BitmapFont.NATIVE_SIZE, 0xFFFFFF));
//			addChild(title = new TextField(400, 100, TITLE_TEXT, BitmapFont.MINI, BitmapFont.NATIVE_SIZE, 0xFFFFFF));
			 ...
			 * button
			 */
			var buttonY : Number = title.y + title.height + 50;
			var buttonScale : int = 1;
			
			var button1 : TextButton;
			addChild(button1 = new TextButton(ONE_PLAYER, buttonScale, 0xFFFFFF, Constants.FONT));
			button1.addEventListener(Event.TRIGGERED, onOnePlayer);
			
//			button1.x = w * 0.5 - button1.width - 5;
			button1.x = (w - button1.width) * 0.5;
			button1.y = buttonY;

			var button2 : TextButton;
			addChild(button2 = new TextButton(TWO_PLAYER, buttonScale, 0xFFFFFF, Constants.FONT));
			button2.addEventListener(Event.TRIGGERED, onTwoPlayer);
			
			button2.x = (w - button2.width) * 0.5;
			button2.y = buttonY + 100;
...
//			info2.scaleX = info2.scaleY = 2;
			...
			info2.y = button2.y + button2.height - 25;
