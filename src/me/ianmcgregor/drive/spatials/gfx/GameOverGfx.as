...
//			addChild(gfx);
			 ...
			 */
			var title : TextField;
			addChild(title = new TextField(600, 100, GAME_OVER, Constants.FONT, BitmapFont.NATIVE_SIZE, 0xFFFFFF));
...
//			title.scaleX = title.scaleY = 2;
			 ...
			 * button
			 */
			var buttonY : Number = title.y + title.height + 100;
			var buttonScale : int = 1;
			
			var button1 : TextButton;
			addChild(button1 = new TextButton(PLAY_AGAIN, buttonScale, 0xFFFFFF, Constants.FONT));
